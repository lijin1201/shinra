...
# Full Model
# ---------------------
class ResNet18_3lbCBAM(nn.Module):
    def __init__(self, pretrained=True, attr = None):
        ...
        self.layer1 = _replace_block_layer_last(base.layer1, CBAMBasicBlock)
        self.layer2 = _replace_block_layer_last(base.layer2, CBAMBasicBlock)
        self.layer3 = _replace_block_layer_last(base.layer3, 
                                                CBAMBasicBlockWithMask if attr=="MGA" else CBAMBasicBlock)
    ...
    def forward(self, x):
        ...
        if self.attr == "MGA" and self.training:
            return x, attn_map
        else:
            return x
