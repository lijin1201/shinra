...
class ResNet18_3lbC_nlbM(nn.Module):
    def __init__(self, pretrained=True, attr = None):
        ...
        self.layer1 = _replace_block_layer_last(base.layer1,
                                                CBAMBasicBlockWithMask if self.mga_level==1 else CBAMBasicBlock)
        self.layer2 = _replace_block_layer_last(base.layer2,
                                                CBAMBasicBlockWithMask if self.mga_level==2 else CBAMBasicBlock)
        self.layer3 = _replace_block_layer_last(base.layer3, 
                                                CBAMBasicBlockWithMask if self.mga_level==3 else CBAMBasicBlock)
    ...
    def forward(self, x):
        ...
        if 3>= self.mga_level >= 1 and self.training:
            return x, attn_map
        else:
            return x
